...
public class Runner {
    public static void main(String[] args) {
        ...
        araba1.yakıtTüketimi();//opel classsındaki method calısır
        ...
        System.out.println("araba2.hiz = " + araba2.hız);//araba classından yazdirir
        System.out.println("araba2.yakit = " + araba2.yakıt);//opel classından yazdirir

        araba2.yakıtTüketimi();//Opel classından yazdirir
